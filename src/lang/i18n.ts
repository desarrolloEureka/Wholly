    ...
    resources: {
      es: {
        translation: {
          ...
          chosenForYou: {
            title: "Elegido para ti",
            description:
              "Aquí encontrarás suplementos que se adaptan a tu perfil médico.",
          },
          general: {
            hola: "Hola",
            no: "No",
          ...
          registerForm: {
            ...
            ErrorMessageTendencies:
              "Debes seleccionar al menos una tendencia para continuar.",
            ErrorMessageConditions:
              "Debes seleccionar al menos una condición para continuar.",
            ErrorMessageAllergies:
              "Debes seleccionar al menos una alergia para continuar.",
            ErrorMessageMedicines:
              "Debes seleccionar al menos una medicina para continuar.",
            ErrorMessageDiseases:
              "Debes seleccionar al menos una enfermedad para continuar.",
            placeholder: "Acné...",
          ...
          userMenu: {
            ...
            myOrders: "Mis pedidos",
            myAddresses: "Mis direcciones",
            myPaymentMethods: "Mis metodos de pago",
            support: "Soporte",
          ...
          PaymentMethodsForm: {
            ...
            defaultCardForShopping: "Tarjeta predeterminada para compras",
            cancel: "Cancelar",
            save: "Guardar",
            goodThru: "Fin de buenas",
          ...
          Orders: {
            ...
            OrdersHistory: "Pedidos historicos",
          },
        },
      },
      en: {
        translation: {
          ...
          chosenForYou: {
            ...
            description:
              "Here you will find supplements that suit your medical profile.",
          },
          general: {
            hello: "Hello",
            no: "No",
          ...
          registerForm: {
            ...
            ErrorMessageTendencies:
              "You must select at least one tendency to continue.",
            ErrorMessageConditions:
              "You must select at least one condition to continue.",
            ErrorMessageAllergies:
              "You must select at least one allergy to continue.",
            ErrorMessageMedicines:
              "You must select at least one medicine to continue.",
            ErrorMessageDiseases:
              "You must select at least one disease to continue.",
            placeholder: "Acne...",
          ...
          Comments: {
            knoWcomments: "Comments and qualification",
          },
          Us: {
          ...
          PaymentMethodsForm: {
            cardNumber: "Card number",
            defaultCardForShopping: "Default card for shopping",
            cancel: "Cancel",
            save: "Save",
            goodThru: "Good Thru",
